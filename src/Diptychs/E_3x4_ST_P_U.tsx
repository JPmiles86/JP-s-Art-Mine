...
const E_3x4_ST_P_U = () => {
  ...
  return (
    <svg viewBox="0 0 615 400" preserveAspectRatio="xMidYMid meet">
      ...
      <image href={imageUrl} x="315" y="0" height="400" width="300" transform="translate(200) scale(-1, 1) rotate(180, 100, 200)" preserveAspectRatio="xMidYMid meet" />
    </svg>
  );
};

export default E_3x4_ST_P_U;
