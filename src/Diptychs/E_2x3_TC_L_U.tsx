...
const E_2x3_TC_L_U = () => {
  ...
  return (
      <svg viewBox="0 0 610 200" preserveAspectRatio="xMidYMid meet">
        ...
        <image href={imageUrl} x="250" y="-110" height="300" width="300" transform="translate(800,0) scale(-1, 1) rotate(270,400,100)" preserveAspectRatio="xMidYMid meet" />
      </svg>
  );
};

export default E_2x3_TC_L_U;
