...
const E_2x3_DS_L_U = () => {
  ...
  return (
      <svg viewBox="0 0 610 200" preserveAspectRatio="xMidYMid meet">
        ...
        <image href={imageUrl} x="250" y="0" height="300" width="300" transform="translate(810,0) scale(-1, 1) rotate(90,400,100)" preserveAspectRatio="xMidYMid meet" />
      </svg>
  );
};

export default E_2x3_DS_L_U;
