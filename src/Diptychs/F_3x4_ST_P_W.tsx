...
const F_3x4_ST_P_W = () => {
  ...
  return (
    ...
    <svg viewBox="0 0 600 400" preserveAspectRatio="xMidYMid meet">
      ...
      <image href={imageUrl} x="300" y="0" height="400" width="300" transform="translate(200) scale(-1, 1) rotate(180, 100, 200)" preserveAspectRatio="xMidYMid meet" />
    </svg>
    </div>
  );
};

export default F_3x4_ST_P_W;
