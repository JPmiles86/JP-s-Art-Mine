...
const F_2x3_CT_P_B = () => {
  ...
  return (
   ...
   <svg viewBox="0 0 400 300" preserveAspectRatio="xMidYMid meet">
      ...
      <image href={imageUrl} x="200" y="0" height="300" width="200" transform="translate(400) rotate(180, 100, 150)" preserveAspectRatio="xMidYMid meet" />
    </svg>
    </div>
  );
};

export default F_2x3_CT_P_B;
