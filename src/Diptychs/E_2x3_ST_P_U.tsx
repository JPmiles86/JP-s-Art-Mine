...
const E_2x3_ST_P_U = () => {
  ...
  return (
    <svg viewBox="0 0 410 300" preserveAspectRatio="xMidYMid meet">
      ...
      <image href={imageUrl} x="210" y="0" height="300" width="200" transform="translate(200) scale(-1, 1) rotate(180, 100, 150)" preserveAspectRatio="xMidYMid meet" />
    </svg>
  );
};

export default E_2x3_ST_P_U;
